package com.example.webprog26.alarmapp.pickers;
...
public class TimeDialog extends DialogFragment{
    ...
    public interface TimeCommunicator{
        void sendTime(int requestCode, int hour, int minute);
    }
        ...
        return new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        {
                            timeCommunicator.sendTime(MainActivity.TIME_PICKER_REQUEST_CODE, hour, minute);
                        }
                    }
                })
